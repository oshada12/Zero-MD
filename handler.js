...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'මෙම විධානය භාවිතා කළ හැක්කේ ඔබට පමණි _*OWWNER!1!1!*_',
        owner: 'මෙම විධානය භාවිතා කළ හැක්කේ ඔබට පමණි _*Owner Bot*_!',
        mods: 'මෙම විධානය භාවිතා කළ හැක්කේ ඔබට පමණි _*Moderator*_ !',
        premium: 'මෙම premium සාමාජිකයින් සඳහා පමණි _*Premium*_ !',
        group: 'මෙම විධානය භාවිතා කළ හැක්කේ කණ්ඩායම් වශයෙන් පමණි!',
        private: 'මෙම විධානය භාවිතා කළ හැක්කේ පුද්ගලික කතාබස් වල පමණි!',
        admin: 'මෙම විධානය සඳහා පමණි *Admin* Group!',
        ...
        restrict: 'මෙම විශේෂාංගය *disable කර ඇත*!'
    }[type]
